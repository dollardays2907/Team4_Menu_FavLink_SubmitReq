...
public class MenuTestcase extends BaseTest{
	...
	@DDDataProvider(datafile = "testdata/testdata1.xlsx", sheetName = "Menu",  testcaseID = "TC1", runmode = "Yes")
	...
	public void verifyMenuItemsTest(Hashtable<String, String> hash) throws UnsupportedEncodingException, InterruptedException, GeneralSecurityException {
		...
		ExtentTestManager.getTest().log(Status.PASS,"Step 2: Verify Mask Sanitizer and PPE Label displays on main menu");
		
		menuPage.forwardBackpacksLabel();
		ExtentTestManager.getTest().log(Status.PASS,"Step 3: Verify Forward Backpacks Label displays on main menu");
	...
	@DDDataProvider(datafile = "testdata/testdata1.xlsx", sheetName = "Menu",  testcaseID = "TC2", runmode = "Yes")
	@Test(dataProvider = "dd-dataprovider", dataProviderClass = TestUtil.class, enabled=true, priority=2)//checking if Mask Sanitizer PPE page displays correctly
	...
	@DDDataProvider(datafile = "testdata/testdata1.xlsx", sheetName = "Menu",  testcaseID = "TC3", runmode = "Yes")
	@Test(dataProvider = "dd-dataprovider", dataProviderClass = TestUtil.class, enabled=true, priority=3)//checking if Forward Backpacks page displays correctly
	public void verifyForwardBackpacksTest(Hashtable<String, String> hash) throws UnsupportedEncodingException, InterruptedException, GeneralSecurityException {
		...
		ExtentTestManager.getTest().log(Status.PASS, "Test Case 3: Verify after clicking on Forward Backpacks Label user lands on the correct page");
	...
	@DDDataProvider(datafile = "testdata/testdata1.xlsx", sheetName = "Menu",  testcaseID = "TC4", runmode = "Yes")
	@Test(dataProvider = "dd-dataprovider", dataProviderClass = TestUtil.class, enabled=true, priority=4)//checking if clicking on Baby displays Baby sub menu correctly
	public void verifyBabyTest(Hashtable<String, String> hash) throws UnsupportedEncodingException, InterruptedException, GeneralSecurityException {
		...
		ExtentTestManager.getTest().log(Status.PASS, "Test Case 4: Verify after clicking on Baby Label submenu displays correctly");
	...
	@DDDataProvider(datafile = "testdata/testdata1.xlsx", sheetName = "Menu",  testcaseID = "TC5", runmode = "Yes")
	@Test(dataProvider = "dd-dataprovider", dataProviderClass = TestUtil.class, enabled=true, priority=5)//checking if FAQ page displays correctly
	public void verifyfAQsTest(Hashtable<String, String> hash) throws UnsupportedEncodingException, InterruptedException, GeneralSecurityException {
		...
		ExtentTestManager.getTest().log(Status.PASS, "Test Case 5: Verify after clicking on FAQs Label user lands on the correct page");
	...
	@DDDataProvider(datafile = "testdata/testdata1.xlsx", sheetName = "Menu",  testcaseID = "TC6", runmode = "Yes")
	@Test(dataProvider = "dd-dataprovider", dataProviderClass = TestUtil.class, enabled=true, priority=6)//checking if elements on FAQ page displays correctly
	public void verifyElementsOnfAQsTest(Hashtable<String, String> hash) throws UnsupportedEncodingException, InterruptedException, GeneralSecurityException {
		...
		ExtentTestManager.getTest().log(Status.PASS, "Test Case 6: Verify after clicking on fAQs from main menu, the FAQs page displays all the elements correctly");
